...
public record CreateProductRequest(
    @Nullable
        @Size(min = 1, max = 50)
        @Schema(description = "Unique SKU code", example = "SKU-001", maxLength = 50)
        String sku,
    @NotBlank
        @Size(max = 100)
        @Schema(description = "Product name", example = "Wireless Mouse", maxLength = 100)
        String name,
    @NotNull @Positive @Schema(description = "Product cost price", example = "15.50")
        BigDecimal cost,
    @NotNull @Positive @Schema(description = "Product sale price", example = "29.99")
        BigDecimal price,
    @NotNull @PositiveOrZero @Schema(description = "Current stock quantity", example = "100")
        Integer stock,
    ...
    @Schema(description = "Set of category IDs to associate", example = "[1, 2, 3]")
